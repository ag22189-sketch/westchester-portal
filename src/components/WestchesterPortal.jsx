...
const towns = [
  ...
  {
    name: "Ho-Ho-Kus",
    lat: 40.9986, lng: -74.1001,
    metroNorth: { line: "NJ Transit Main Line", station: "Ho-Ho-Kus", timeToGCT: 57 },
    tagline: "Quiet Bergen County borough, top schools",
    metro: 57,
    medianPrice: 1050000,
    taxRate: 2.5,
    schools: 9,
    walkability: 35,
    vibe: "Small leafy NJ borough, excellent schools, car-dependent, NJ Transit to Penn via Secaucus transfer",
    dining: 2,
    clubs: ["Ridgewood CC (nearby)", "Arcola CC (nearby)"],
    highlights: ["Top-rated Northern Highlands schools", "Quiet residential streets", "NJ Transit Main Line", "Low crime"],
    color: "#7BA68C",
    hospitals: [
      { name: "Valley Hospital", distance: "8 min", rating: "High Performing", note: "Top community hospital in Bergen County" },
      { name: "Hackensack University Medical Center", distance: "15 min", rating: "★ Major Academic Center", note: "Level 1 trauma, top cancer center" },
    ],
    population: 4100,
    density: "Small borough — quiet residential, car-dependent",
    demographics: { white: 82, asian: 10, hispanic: 4, black: 2, other: 2 },
    religion: "Protestant and Catholic congregations. Community-oriented churches anchor the borough.",
    voting: { dem: 50, rep: 48 },
    editorial: "Ho-Ho-Kus is the kind of place that doesn't advertise itself — and that's the appeal. A tiny Bergen County borough with excellent schools, mature trees, and a silence that feels almost radical compared to the bustle of nearby Ridgewood. The commute is longer than Westchester options, but the trade-off is space, privacy, and a property tax rate that's competitive. Buyers here are choosing calm over convenience.",
    history: "Named after Chief Oratam of the Lenape, Ho-Ho-Kus was incorporated in 1908. The Ho-Ho-Kus Inn, built in 1790, served as a tavern during the Revolutionary War and hosted George Washington. The borough split from Orvil Township and has remained one of the smallest municipalities in Bergen County.",
    notableResidents: ["George Washington (stayed at the Ho-Ho-Kus Inn)", "Local community leaders"],
    events: ["Ho-Ho-Kus Day", "Holiday Tree Lighting", "Summer Concert Series", "Community Yard Sale"],
    highSchool: {
      name: "Northern Highlands Regional High School",
      mascot: "Highlanders",
      colors: "Blue & Gold",
      sports: ["Football", "Lacrosse", "Soccer", "Swimming", "Track & Field"],
      arts: ["Theater program", "Concert band", "Visual arts", "Literary magazine"],
    },
    brokerages: [
      { firm: "Prominent Properties Sotheby's", note: "Strong Bergen County luxury coverage", agents: [
        { name: "Local Agent", phone: "2016700100", email: "info@prominentproperties.com", specialty: "Ho-Ho-Kus & upper Bergen County" },
      ]},
      { firm: "Coldwell Banker", note: "Deep Bergen County presence", agents: [
        { name: "Local Agent", phone: "2016700200", email: "info@coldwellbanker.com", specialty: "Ho-Ho-Kus, Ridgewood corridor" },
      ]},
      { firm: "Compass", note: "Growing NJ suburban presence", agents: [
        { name: "Local Agent", phone: "2016700300", email: "info@compass.com", specialty: "Bergen County communities" },
      ]},
    ],
  },
  {
    name: "Ridgewood",
    lat: 40.9793, lng: -74.1166,
    metroNorth: { line: "NJ Transit Bergen/Main Line", station: "Ridgewood", timeToGCT: 58 },
    tagline: "Vibrant walkable downtown, top schools",
    metro: 58,
    medianPrice: 1130000,
    taxRate: 2.5,
    schools: 9,
    walkability: 70,
    vibe: "Bustling Bergen County village, walkable downtown, strong schools, NJ Transit Main/Bergen Line to Penn",
    dining: 5,
    clubs: ["Ridgewood CC", "Arcola CC"],
    highlights: ["Vibrant walkable downtown", "Top-rated schools", "NJ Transit Bergen/Main Line", "Strong restaurant & shop scene"],
    color: "#6B8EAD",
    hospitals: [
      { name: "Valley Hospital", distance: "5 min", rating: "High Performing", note: "Top community hospital in Bergen County" },
      { name: "Hackensack University Medical Center", distance: "12 min", rating: "★ Major Academic Center", note: "Level 1 trauma, top cancer center" },
    ],
    population: 25500,
    density: "Village — walkable downtown core, residential neighborhoods",
    demographics: { white: 76, asian: 14, hispanic: 5, black: 3, other: 2 },
    religion: "Broad mix — Catholic, Protestant, Jewish congregations all well represented. Old Paramus Reformed Church dates to 1735.",
    voting: { dem: 54, rep: 44 },
    editorial: "Ridgewood is the Bronxville of Bergen County — a walkable village with serious schools, serious restaurants, and serious real estate. The downtown is genuinely vibrant, with independent shops and dining that rival any Westchester village. The commute to Penn Station via NJ Transit is longer than Metro-North options to Grand Central, but for buyers who work midtown west or remote-hybrid, it's a compelling alternative. The town has swagger without pretension.",
    history: "Settled by the Dutch in the 1600s, Ridgewood was incorporated as a village in 1894. The Schedler estate and the Van Allen House (c. 1740) reflect its colonial roots. The village became a commuter suburb with the arrival of the Erie Railroad. Its downtown was designated a historic district and remains one of the most walkable in northern New Jersey.",
    notableResidents: ["Nelson Shanks (portrait artist)", "Kristin Davis (actress)", "Joan Rivers (comedian, grew up nearby)"],
    events: ["Ridgewood Guild International Food Festival", "Fourth of July Celebration", "Holiday Stroll", "Ridgewood Run 5K", "Farmers Market"],
    highSchool: {
      name: "Ridgewood High School",
      mascot: "Maroons",
      colors: "Maroon & White",
      sports: ["Football", "Lacrosse (strong)", "Swimming (strong)", "Soccer", "Tennis"],
      arts: ["Award-winning theater program", "Orchestra & band", "Visual arts", "Film program"],
    },
    brokerages: [
      { firm: "Prominent Properties Sotheby's", note: "Leading Bergen County luxury firm", agents: [
        { name: "Local Agent", phone: "2016700100", email: "info@prominentproperties.com", specialty: "Ridgewood village specialist" },
      ]},
      { firm: "Coldwell Banker", note: "Deep Ridgewood presence", agents: [
        { name: "Local Agent", phone: "2016700200", email: "info@coldwellbanker.com", specialty: "Ridgewood & surrounding villages" },
      ]},
      { firm: "Compass", note: "Growing NJ presence with NYC transplants", agents: [
        { name: "Local Agent", phone: "2016700300", email: "info@compass.com", specialty: "Ridgewood, Bergen County communities" },
      ]},
    ],
  },
];
